...
const mostrarComponentes = (componente) => {
    const allComponentes = document.getElementById("all-componentes")
    for (let i = 0; i < allComponentes.children.length; i++) {
        const element = allComponentes.children[i];
        element.classList.add("hidden")
    }
    return document.getElementById(componente).classList.remove("hidden")
}
...
// Arrow function para crear una card por cada objeto
const mostrarMotherboards = (array) => {
    contenedorcomponentes.innerHTML = ''

    arrayMotherboards.forEach((mother) => {
    ...
    <img src=${mother.img} class="card-img-top" alt="...">
    <h5 class="card-title"> ${mother.nombre} </h5>
    <p class="card-text">Precio: $${mother.precio} </p>
    <button onclick="agregarAlCarrito(${mother.id}, 'procesadores')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `
...
mostrarMotherboards(arrayMotherboards)


// PROCESADORES

// Arrow function para crear una card por cada objeto
const mostrarProcesadores = (array) => {
    contenedorProcesadores.innerHTML = ''
    
    arrayProcesadores.forEach((procesador) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
    ...
    <button onclick="agregarAlCarrito(${procesador.id}, 'ram')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `
    
    contenedorProcesadores.appendChild(div)
})
}
mostrarProcesadores(arrayProcesadores)

// RAM

// Arrow function para crear una card por cada objeto
const mostrarRam = (array) => {
    contenedorMemoriaRam.innerHTML = ''

    arrayRAM.forEach((ram) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
        ...
        div.innerHTML = `
    <div class="card-body row">
    <img src=${ram.img} class="card-img-top" alt="...">
    <h5 class="card-title"> ${ram.nombre} </h5>
    <p class="card-text">Precio: $${ram.precio} </p>
    <button onclick="agregarAlCarrito(${ram.id}, 'video')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `

        contenedorMemoriaRam.appendChild(div)
    })
}
...
// Arrow function para crear una card por cada objeto
const mostrarVideo = (array) => {
    contenedorVideo.innerHTML = ''

    arrayVideo.forEach((video) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
    ...
    <p class="card-text">Precio: $${video.precio} </p>
    <button onclick="agregarAlCarrito(${video.id}, 'disco')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `

        contenedorVideo.appendChild(div)
    })
}

mostrarVideo(arrayVideo)
...
// Arrow function para crear una card por cada objeto
const mostrarDisco = (array) => {
    contenedorDisco.innerHTML = ''

    arrayDisco.forEach((disco) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
        ...
        div.innerHTML = `
    <div class="card-body row">
    <img src=${disco.img} class="card-img-top" alt="...">
    <h5 class="card-title"> ${disco.nombre} </h5>
    <p class="card-text">Precio: $${disco.precio} </p>
    <button onclick="agregarAlCarrito(${disco.id}, 'fuente')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `

        contenedorDisco.appendChild(div)
    })
}

mostrarDisco(arrayDisco)

// FUENTE

// Arrow function para crear una card por cada objeto
const mostrarFuente = (array) => {
    contenedorFuente.innerHTML = ''

    arrayFuentes.forEach((fuente) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
        ...
        div.innerHTML = `
    <div class="card-body row">
    <img src=${fuente.img} class="card-img-top" alt="...">
    <h5 class="card-title"> ${fuente.nombre} </h5>
    <p class="card-text">Precio: $${fuente.precio} </p>
    <button onclick="agregarAlCarrito(${fuente.id}, 'gabinete')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `

        contenedorFuente.appendChild(div)
    })
}

mostrarFuente(arrayFuentes)

// GABINETE

// Arrow function para crear una card por cada objeto
const mostrarGabinete = (array) => {
    contenedorGabinete.innerHTML = ''

    arrayGabinetes.forEach((gabinete) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
        ...
        div.innerHTML = `
    <div class="card-body row">
    <img src=${gabinete.img} class="card-img-top" alt="...">
    <h5 class="card-title"> ${gabinete.nombre} </h5>
    <p class="card-text">Precio: $${gabinete.precio} </p>
    <button onclick="agregarAlCarrito(${gabinete.id}, 'monitor')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `

        contenedorGabinete.appendChild(div)
    })
}

mostrarGabinete(arrayGabinetes)

// MONITOR

// Arrow function para crear una card por cada objeto
const mostrarMonitor = (array) => {
    contenedorMonitor.innerHTML = ''

    arrayMonitores.forEach((monitor) => {
        const div = document.createElement('div')
        div.className = 'card-img-top'
        div.style = 'width: 18rem'
    ...
    <h5 class="card-title"> ${monitor.nombre} </h5>
    <p class="card-text">Precio: $${monitor.precio} </p>
    <button onclick="agregarAlCarrito(${monitor.id}, 'carrito-final')" class="btn btn-primary">Agregar al carrito</button>
    </div>
    `
...
const mostrarCarrito = () => {
    ...
    carrito.forEach((prod) => {
        ...
        <h5 class="card-text">Precio: $${prod.precio} </h5>
        <h5 class="card-text">Precio TOTAL: $${total} </h5>
        `
...
const agregarAlCarrito = (itemId, componentes) => {
    const producto = arrayProductos.find((prod) => prod.id === itemId)
